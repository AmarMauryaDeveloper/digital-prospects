...
export default function TrustSection() {
  ...
  return (
    <section className="w-full relative bg-gradient-to-tr from-[#ffffff] via-[#fff] to-[#f9e4e6] py-6 md:py-12">
      <div className="container mx-auto px-4 md:px-18 grid grid-cols-1 md:grid-cols-2 gap-1 items-center">
        ...
        {/* TEXT CONTENT */}
        <div className="">
          <h2 className="text-3xl md:text-4xl font-bold leading-13 text-[#233A41] mb-4 ">
